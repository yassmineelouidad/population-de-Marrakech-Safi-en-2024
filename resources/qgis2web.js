...
map.getView().fit([-1197508.962871, 3492006.668887, -416945.937225, 3978006.989120], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte du recensement 2024 de la population pour la région Marrakech-Safi by (Yassmine El ouidad)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (187 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Réalisation d\'une carte choroplète interactive basée sur la variation de la population entre les différentes provinces de la région de Marrakch Safi selon le recensement du septembre 2024';
            }
